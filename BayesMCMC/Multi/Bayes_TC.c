...
int main(int argc, char **argv){
	...
	double *temp16,*temp17,*temp18,*temp19, *temp20, *temp21; /*monte carlo steps*/
	double *fmle;
	double *V_Mmle;
	double *V_Fmle;
	double maxlike;
...
/*variables for use of random number geneator*/
	...
	/*monte carlo thermalization step*/
	 ...
	 for(i=1;i<n_steps;i++){
		 ...
		 scalar_multiply(temp17,0.005, temp16, MaxPop, 1);
		 scalar_multiply(temp19,0.005, temp18, Nbins, 1);
		 scalar_multiply(temp21,0.005, temp20, Nbins, 1);
