function conjugdir=getconjugdir(params,pastparams,pastconjugdir, MaxPop,Nbins,Tframes, hist)
...
pastgrad=logligrad(pastparams ,  MaxPop,Nbins,Tframes, hist); %gradient in the last iteration
grad=logligrad(params , MaxPop,Nbins,Tframes, hist); %gradient in this iteration
