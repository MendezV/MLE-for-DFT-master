function conjugdir=getconjugdirmap(params,pastparams,pastconjugdir, MaxPop,Nbins,Tframes, hist)
...
pastgrad=logpostgrad(pastparams ,  MaxPop,Nbins,Tframes, hist); %gradient in the last iteration
grad=logpostgrad(params , MaxPop,Nbins,Tframes, hist); %gradient in this iteration
