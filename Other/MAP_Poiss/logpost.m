...
%a huge number 
logp=Tframes*sum(log(z)+V.*NexpAv+fmeanexp+loggammaav)+sum(sum(gammaln(Tframes*hist+1)))-Nbins*gammaln(Tframes+1)+0.5*0.1*(f'*f)+0.5*0.1*(V'*V)+0.5*(MaxPop+1+Nbins)*log(2*pi);
