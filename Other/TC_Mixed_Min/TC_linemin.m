function alpha=TC_linemin(params,conjugdir,alpharoot, MaxPop_F, MaxPop_M, Nbins, Tframes, hist, N_F, N_M, NFNMfac, NexpAv_F, NexpAV_M, grad)
...
pastLogli=TC_logli(params , MaxPop_F, MaxPop_M, Nbins,Tframes, hist, N_F, N_M, NFNMfac, NexpAv_F, NexpAV_M);
diff=pastLogli-TC_logli(params+alpha*conjugdir , MaxPop_F, MaxPop_M, Nbins,Tframes, hist, N_F, N_M, NFNMfac, NexpAv_F, NexpAV_M); %%difference that will be minimized
%grad2=TC_logligrad(params+ alpha*conjugdir, MaxPop_F, MaxPop_M, Nbins, Tframes, hist, N_F, N_M, NFNMfac, NexpAv_F, NexpAV_M);
